...
import cc.lixou.stracciatella.item.extensions.setHeadTexture
...
object MenuItem : CustomItem(
    ...
    {
        it.meta { meta ->
            meta.setHeadTexture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzUzNWZmZDY5N2Q2YzBkOTc2MTc1ODE2ZTQxNjhjYmM0Y2EyOWQzYThlNzFiMTNhMWQ1Zjk1NDNjNTYyY2ExIn19fQ==")
            meta.displayName("<gray>» <gradient:gold:yellow><bold>BeachBuilders Menu</bold> <gray>«".formatMini().noItalic())
        }
    ...
    private fun openInventory(player: Player) {
        val inventory = Inventory(InventoryType.CHEST_5_ROW, "<gradient:gold:yellow><bold>BeachBuilders Menu".formatMini())
